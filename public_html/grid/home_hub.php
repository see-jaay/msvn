...
<div id="nav_wrapper" class="nav-wrapper home">
	<ul id="menu_main" class=" menu add-c">
		...
		<li class="disabled trh" data-trh="coming.soon"><div><span>[</span>machsevn.shop<span>]</span></div></li>
...
<div id="secondary_nav_wrapper">
	<ul id="secondary_menu_main">
		<!-- <li class="disabled"><div onclick="window.location.hash = 'gallery';"><span>[</span>GALLERY<span>]</span></div></li> -->
		<!-- <li class="disabled"><div onclick="window.location.hash = 'info';"><span>[</span>MACHSEVN.INFO<span>]</span></div></li> -->
		<li class="disable" data-trc="inquiries" onclick="TRC(this);"><div onclick="hsh('creative-solutions');"><span>[</span>need a website?<span>]</span></div></li>
	</ul>
</div>
...
<div id="util_wrapper">
	<div id="cart_container" onclick="cartFlyout(1);">
		<div>cart</div>
		<script type="text/javascript">
			updateCart(0, null);
		</script>
	...
	<div id="search_container" onclick="searchFlyout(1);">
		<div>search</div>
	</div>
</div>