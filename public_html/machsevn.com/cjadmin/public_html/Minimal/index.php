...
<body>
	...
	<div id="page_wrapper" data-pos="0">
		...
		<div id="home_page_container" class="aside-page-container" data-pgid="0" data-page="home"></div>
		...
		<!-- <div id="vineArt_cover"></div> -->
		<div id="vineArt"></div>
		
		<div class="center-text" id="center_text">MACHSEVN</div>
		<!-- <div id="title_text">M A C H S E V N</div> -->
...
<!-- <svg width="0" height="0" id="mcPath">
  <defs>
  	<filter id="f1" x="0" y="0">
      <feGaussianBlur in="SourceGraphic" stdDeviation="200" />
    </filter>
    <clipPath id="myClip">
		<path d="M0,0v149.2h219V0H0z M109.5,116.3c-23,0-41.7-18.7-41.7-41.7s18.7-41.7,41.7-41.7s41.7,18.7,41.7,41.7 S132.5,116.3,109.5,116.3z"/>
		<
    </clipPath>
  </defs>
</svg> -->
