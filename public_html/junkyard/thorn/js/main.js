$.getScript("js/Global/CanvasObject.js");
...
function SetLayout(mode){
	...
	if(!ui)
	{
		$.getScript("js/Interface.js", function(){
			ui = new Interface();
			ui.Init();
			ui.SetLayout(mode);
		});
...
function Update(){
	...
	if(ui)
	{
		window.requestAnimationFrame(function(){ui.Update(deltaTime);})
		// ui.Update(deltaTime);
...
function AdminAccess() {
	$.getScript("js/admin.js", function(){
		$.getScript("js/XMLManager.js");
		$.getScript("js/window.js");
		// $.getScript("js/JSONC.js");
